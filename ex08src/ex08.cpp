...
int main( void )
{
	...
	// ---------------------------------------------
	// Shader to render the depth into texture
	// ---------------------------------------------

	// Create and compile our GLSL program from the shaders
	GLuint depthProgramID = LoadShaders( "DepthRTT.vs", "DepthRTT.fs" );
	...
	// ---------------------------------------------
	// Basic shader to test whether each fragment
	// is behind the shadow map or not
	// ---------------------------------------------

	// Create and compile our GLSL program from the shaders
	GLuint programID = LoadShaders( "ShadowMapping.vs", "ShadowMapping.fs" );
  ...
  GLuint lightInvDirID = glGetUniformLocation(programID, "LightInvDirection_worldspace");
	...
	do{
		...
		// compute the MVP matrix used to render the scene
		...
		// Trick for transforming vertex position in [-1, 1]
		// obtained through depthMVP into
		// texture sample values in [0, 1]
		glm::mat4 biasMatrix(
				     0.5, 0.0, 0.0, 0.0,
				     0.0, 0.5, 0.0, 0.0,
				     0.0, 0.0, 0.5, 0.0,
